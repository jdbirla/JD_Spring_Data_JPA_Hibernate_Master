...
public class MySQLIntegrationTest {
    ...
    void testAuthorUuid()
    {
        AuthorUuid saveAuthorId = authorUuidRepository.save(new AuthorUuid());
        assertThat(saveAuthorId).isNotNull();
        assertThat(saveAuthorId.getId()).isNotNull();

        AuthorUuid byId = authorUuidRepository.getById(saveAuthorId.getId());
